...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      Sitemap({
        hostname: "https://daniel-board.vercel.app",
        outDir: "build",
        changefreq: "monthly",
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Daniel Board",
          name: "Daniel Board",
          description:
            "Daniel Board is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
